  ...
  if (!message.member.hasPermission("MANAGE_GUILD")){
    ...
    var duration = moment.duration(client.uptime).format(" D [gün] H [saat] m [dakika] s [saniye]")
        ...
        var embed = new Discord.RichEmbed()
            .setColor('AQUA')
            .setAuthor('Dipper Bilgi')
            .setThumbnail(message.guild.iconURL)
            .addField('Bot Bilgisi', `**Bot Sahibi**: Afrodex#9712 \n**Bulunduğun Sunucunun ID:** ${message.guild.id}\n**Bulunduğun Sunucunun Bölgesi:** ${region[message.guild.region]}\n**Doğrulama Seviyesi: ** Botun Doğrulaması Bulunmaktadır \n**Varsayılan Rol: ** ${message.guild.defaultRole}` )
            .addField('Ayrıntılı Bilgiler', `**Müzik Komutları **!müzikbilgi yazarak ulaşabilirsiniz \n**Oto rol Komutları: !otorolbilgi yazarak ulaşabilirsiniz ** \n**Bot davet linki: ** https://discord.com/oauth2/authorize?client_id=766310650375831614&scope=bot&permissions=8\n**Varsayılan Kanal: ** ${message.guild.defaultChannel ? message.guild.defaultChannel : 'Varsayılan Kanal Yok'}`)
...
exports.conf = {
  enabled: true,
  guildOnly: false,
  aliases: ["Dipper", "Dipper-bilgi", "dbilgi", "db"],
  permLevel: 0,
}
exports.help = {
  name: 'Dipperbilgi',
