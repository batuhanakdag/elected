...
exports.conf = {
  enabled: true,
  guildOnly: false,
  aliases: ['Fal', 'fal-yap', 'yap-fal', 'bifal-yap'],
  permLevel: 0
};

exports.help = {
  name: 'fal',
  description: 'fal okur.',
  usage: 'fal'
};
